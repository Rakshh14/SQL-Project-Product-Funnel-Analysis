...
Visit → Signup → Email Verification → Purchase Dataset
...
Visit 4 users ↓ Signup 3 users ↓ Verify Email 2 users ↓ Purchase 1 user

Conversion rates:

Signup Conversion Rate = 75% Purchase Conversion Rate = 50%
...
Step Users Visit → Signup 1 user lost Signup → Verification 1 user lost Verification → Purchase 1 user lost
...
Date Event Users 2025-01-01 visit 2 2025-01-01 signup 2 2025-01-02 visit 2 2025-01-02 signup 1
...
Signup conversion is relatively strong, indicating effective initial engagement.

A noticeable drop occurs between signup and email verification, suggesting friction in the verification process.

Purchase conversion is lower, which may indicate: a. Lack of user trust during payment b. Pricing concerns c. Poor onboarding experience d. Product Recommendations
...
Add trust signals before checkout

Provide incentives for first purchase

====================================================

Project Structure sql-funnel-analysis
│
├── dataset.sql
├── funnel_analysis.sql
